...
def createPlayerProfile(season,allTime,player,TrackIndex):
  ...
  coverPage(player,season,allTime,TrackIndex,seasonalTotalPoints,seasonalAverage,seasonalTotalRaces,seasonalFirstPlaceEquivilent,allTimeAverage,
              ...
              dfSeasonBlue,dfSeasonOwnedScore, allTimeTotalPoints,allTimeTotalRaces,allTimeFirstPlaceEquivilent,dfAllTimeWins,dfAllTimeShock,dfAllTimeBlue,dfAllTimeOwnedScore) 
  
  time.sleep(30) #API calls aint free
